...
class Payment {
    ...
    @Column(name = "way_pay") val wayPay: String? = null

    @Column(name = "name") val name: String? = null

    @Column(name = "total") val total: BigDecimal? = null

    @Column(name = "payment_deadline") val paymentDeadline: BigDecimal? = null

    @Column(name = "unit_time") val unitTime: String? = null
}
