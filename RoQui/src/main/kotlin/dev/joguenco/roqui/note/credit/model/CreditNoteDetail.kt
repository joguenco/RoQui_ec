...
@Entity
@Immutable
@Table(name = "v_ele_credit_notes_detail")
class CreditNoteDetail {
    ...
    @Column(name = "value_iva") val valueIva: BigDecimal? = null

    @Column(name = "discount") val discount: BigDecimal? = null

    @Column(name = "total_price_without_tax") val totalPriceWithoutTax: BigDecimal? = null
}
