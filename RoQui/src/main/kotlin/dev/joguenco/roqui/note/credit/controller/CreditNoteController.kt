...
class CreditNoteController {
    ...
    @PostMapping("/v2/creditnote/authorize/dates/{startDate}/{endDate}")
    ...
    @PostMapping("/v1/credit/note/authorize/dates/{startDate}/{endDate}")
    ...
    @PostMapping("/v1/credit/note/check/dates/{startDate}/{endDate}")
    fun postCheckAll(
        @PathVariable(value = "startDate") startDate: String,
        @PathVariable(value = "endDate") endDate: String,
    ): ResponseEntity<out Any?> {
