...
class DebitNote {
    ...
    @Column(name = "updated_code_document") val updatedCodeDocument: String? = null

    @Column(name = "updated_number_document") val updatedNumberDocument: String? = null

    @Column(name = "updated_date_document", columnDefinition = "DATE")
    val updatedDateDocument: Date? = null
